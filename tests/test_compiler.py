...
class TestCompiler:
    ...
    def _test_compile_no_unitary_primitives(self, compiler):
        target_unitary = Unitary(qubit_dimension)
        with pytest.raises(Exception):
            compiler.compile(target_unitary)

    def _test_compile_cnot(self, compiler):
    ...
    def _test_compile_sigmaz(self, compiler):
    ...
    def test_compile_no_unitary_primitives(self):
        compiler = Compiler(qubit_dimension)
